define(function(require) {
    ...
    var pageHiddenField = document.getElementById('page-hidden-field');
    ...
    nest.qs(hb.selectors.files).delegate('click', 'li', function(click) {
        ...
        var containers = nest.qs('.hb-field-container');
        containers = containers.forEach ? containers : [containers];
